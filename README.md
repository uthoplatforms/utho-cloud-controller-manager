...
To deploy the versioned CCM that Vultr providers you will need to apply two yaml files to your cluster which can be found [here](https://github.com/utho/utho-cloud-controller-manager/tree/master/docs/releases).
